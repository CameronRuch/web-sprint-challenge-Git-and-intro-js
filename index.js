...
function getArtistByIndex(array, indNum) {
  return `the artist at index ${indNum} is ${array[indNum].name}`;
}
...
2. Add this object of information to the end of the array
  { 
    ...
    bio: Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris suscipit convallis mauris, sed molestie metus gravida eget.
  }  
